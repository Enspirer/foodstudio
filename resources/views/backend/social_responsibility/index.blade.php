        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn btn-primary pull-right ml-3" data-toggle="modal" data-target="#exampleModal">Add Image</div>
                    <div class="btn btn-primary pull-right ml-3" data-toggle="modal" data-target="#exampleModalvideo">Add Video</div>
    ...
    <div class="modal fade" id="exampleModalvideo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.social.storetwo')}}" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#villadatatable').DataTable({
                processing: true,
                ajax: "{{route('admin.social.GetTableDetails')}}",
                serverSide: true,
                order: [[0, "desc"]],
                columns: [
                    {data: 'id', name: 'id'},
